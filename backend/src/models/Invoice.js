...
const schema=new mongoose.Schema({
  ...
  ocrFields:{type:mongoose.Schema.Types.Mixed,default:{}},lineItems:{type:[lineSchema],default:[]},highRiskConfirmed:{type:Boolean,default:false},approvedBy:{type:mongoose.Schema.Types.ObjectId,ref:'User',default:null},approvedAt:Date,rejectionReason:String
},{timestamps:true});
